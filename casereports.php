...
function casereports_civicrm_install() {
  return _casereports_civix_civicrm_install();
}
...
function casereports_civicrm_uninstall() {
  return _casereports_civix_civicrm_uninstall();
}
...
function casereports_civicrm_enable() {
  return _casereports_civix_civicrm_enable();
}
...
function casereports_civicrm_disable() {
  return _casereports_civix_civicrm_disable();
}
...
function casereports_civicrm_managed(&$entities) {
  return _casereports_civix_civicrm_managed($entities);
}
