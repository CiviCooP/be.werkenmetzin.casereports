...
class CRM_Casereports_Form_Report_eerstevoorkeur extends CRM_Report_Form {
	...
	function fetchEerstelocatie() {
		try {
			...
			$this->_customFields->locatievoorkeur 	= civicrm_api3('CustomField','getsingle',array("name" => "Locatievoorkeur_1e", "custom_group_id" => $this->_customGroup['id']));
