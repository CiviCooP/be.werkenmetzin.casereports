...
class CRM_Casereports_Form_Report_tweedevoorkeur extends CRM_Report_Form {
...
protected $_addressField = FALSE;
	...
	function fetchTweedelocatie() {
		try {
			$this->_customGroup 					= civicrm_api3('CustomGroup','getsingle',array("name" => "ind_job_coaching"));
			$this->_customFields 					= new stdClass;
			$this->_customFields->locatievoorkeur 	= civicrm_api3('CustomField','getsingle',array("name" => "location_preference_2nd", "custom_group_id" => $this->_customGroup['id']));
